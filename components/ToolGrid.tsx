...
const ALL_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    description: 'Convert SVG to high-resolution PNG, WebP or JPEG with custom scaling (up to 4x) for Retina displays.',
    href: '/svg-to-png',
  ...
  },
  {
    ...
    description: 'Transform JPG and PNG images into scalable vector graphics (SVG) with high-fidelity color tracing.',
    href: '/jpeg-to-svg',
    categories: ['Design', 'Web'],
    isHot: true,
  },
  {
    id: 'svg-optimizer',
    name: 'SVG Optimizer',
    description: 'Clean and minify SVG code online by removing metadata, hidden layers, and optimizing path precision.',
    href: '/svg-optimizer',
    categories: ['Design', 'Web'],
    isHot: false,
  },
  ...
  },
  {
    ...
    description: 'Use JSONPath or Dot notation to filter and extract specific data from complex JSON objects instantly.',
    href: '/json-extractor',
    categories: ['JSON', 'Data Parsing'],
    isHot: true,
  },

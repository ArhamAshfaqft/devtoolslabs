...
const ALL_TOOLS: Tool[] = [
  ...
  },
  {
    id: 'jwt-generator',
    name: 'JWT Generator',
    description: 'Create and sign custom JSON Web Tokens for testing and development.',
    href: '/jwt-generator',
  ...
  },
  {
    id: 'jwt-decoder',
    name: 'JWT Decoder',
    description: 'Instantly decode JSON Web Tokens into visual Header, Payload, and Signature blocks.',
    href: '/jwt-decoder',
    categories: ['Security', 'Formatting'],
    isHot: true,
  },
  {
    id: 'chmod-calculator',

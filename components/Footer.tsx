        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link href="/" className="font-bold text-xl tracking-tight text-gray-900 mb-4 inline-block">
              DevTools<span className="text-gray-400">Hub</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-600">
              ...
              <li><a href="https://github.com" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900 transition-colors">GitHub</a></li>
